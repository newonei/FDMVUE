...
import { batchSetBlankPic } from '#/api/fdmdata/datajustsku';
...
async function handleConfirm() {
  ...
  modalApi.lock();
  try {
    await batchSetBlankPic({ ids: selectedIds.value, picUrl: url });
...
<template>
  <Modal title="批量设置图片（空白版列表）" :show-confirm-button="false">
