...
export function useFormSchema(): VbenFormSchema[] {
  return [
    ...
    },
    {
      ...
      componentProps: {
        allowClear: true,
        placeholder: 'updates.xml 的 HTTPS 地址',
      },
      formItemClass: 'md:col-span-2',
    },
    {
  ...
  return [
    ...
    { field: 'version', title: '版本号', minWidth: 100, fixed: 'left' },
    {
      ...
      formatter: ({ cellValue }: { cellValue: unknown }) =>
        optionLabel(BROWSER_OPTIONS, cellValue),
    },
    { field: 'channel', title: '通道', minWidth: 90 },
    {
      ...
      minWidth: 90,
      formatter: ({ cellValue }: { cellValue: unknown }) =>
        optionLabel(PUBLISHED_OPTIONS, cellValue),
    },
    {
    ...
    { field: 'minSupportedVersion', title: '最低支持版本', minWidth: 120 },
    {
      ...
      minWidth: 90,
      formatter: ({ cellValue }: { cellValue: unknown }) =>
        optionLabel(YES_NO_OPTIONS, cellValue),
    },
    {
      field: 'downloadUrl',
      title: '下载地址',
