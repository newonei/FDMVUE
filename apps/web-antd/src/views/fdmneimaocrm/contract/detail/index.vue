...
import { getContract } from '#/api/fdmneimaocrm/contract';
...
const contract = ref<FdmNeimaoCrmContractApi.Contract>(
  {} as FdmNeimaoCrmContractApi.Contract,
); // 合同详情
...
function handleBack() {
  ...
  router.push({ name: 'FdmNeimaoCrmContract' });
}
