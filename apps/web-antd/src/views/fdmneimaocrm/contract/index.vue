...
import {
  ...
  getContractPage,
  submitContract,
} from '#/api/fdmneimaocrm/contract';
...
/** 编辑合同 */
function handleEdit(row: FdmNeimaoCrmContractApi.Contract) {
  formModalApi.setData(row).open();
}

/** 删除合同 */
async function handleDelete(row: FdmNeimaoCrmContractApi.Contract) {
...
/** 提交审核 */
async function handleSubmit(row: FdmNeimaoCrmContractApi.Contract) {
  const hideLoading = message.loading({
    content: '提交审核中...',
    duration: 0,
  });
...
/** 查看合同详情 */
function handleDetail(row: FdmNeimaoCrmContractApi.Contract) {
...
function handleBusinessDetail(row: FdmNeimaoCrmContractApi.Contract) {
  push({ name: 'FdmNeimaoCrmBusinessDetail', params: { id: row.businessId } });
}
          ...
          :actions="[
            {
              ...
              auth: ['fdmneimaocrm:contract:create'],
            ...
            },
            {
              ...
              auth: ['fdmneimaocrm:contract:export'],
        ...
        <TableAction
          :actions="[
            ...
            },
            {
              ...
              type: 'link',
              danger: true,
              auth: ['fdmneimaocrm:contract:delete'],
              popConfirm: {
