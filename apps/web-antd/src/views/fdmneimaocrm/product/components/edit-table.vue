...
const props = defineProps<{
  bizType: BizTypeEnum;
  products?:
    | FdmNeimaoCrmBusinessApi.BusinessProduct[]
    | FdmNeimaoCrmContractApi.ContractProduct[];
}>();
...
/** 删除产品行 */
function handleDelete(row: FdmNeimaoCrmProductApi.Product) {
...
/** 初始化 */
const productOptions = ref<FdmNeimaoCrmProductApi.Product[]>([]); // 产品下拉选项
onMounted(async () => {
