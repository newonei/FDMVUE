...
import { getProduct } from '#/api/fdmneimaocrm/product';
...
const product = ref<FdmNeimaoCrmProductApi.Product>(
  {} as FdmNeimaoCrmProductApi.Product,
); // 产品详情
...
function handleBack() {
  ...
  router.push({ name: 'FdmNeimaoCrmProduct' });
}
