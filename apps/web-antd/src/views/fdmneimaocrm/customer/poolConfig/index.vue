...
import type { FdmNeimaoCrmCustomerPoolConfigApi } from '#/api/fdmneimaocrm/customer/poolConfig';
...
} from '#/api/fdmneimaocrm/customer/poolConfig';
...
async function handleSubmit() {
  ...
  // 提交表单
  const data =
    (await formApi.getValues()) as FdmNeimaoCrmCustomerPoolConfigApi.CustomerPoolConfig;
  if (!data.enabled) {
