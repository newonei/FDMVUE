...
import type { FdmNeimaoCrmCustomerApi } from '#/api/fdmneimaocrm/customer';
...
} from '#/api/fdmneimaocrm/customer';
import { getOperateLogPage } from '#/api/fdmneimaocrm/operateLog';
import { BizTypeEnum } from '#/api/fdmneimaocrm/permission';
import { useDescription } from '#/components/description';
import { OperateLog } from '#/components/operate-log';
import { ACTION_ICON, TableAction } from '#/components/table-action';
import { $t } from '#/locales';
import { BusinessDetailsList } from '#/views/fdmneimaocrm/business/components';
import { ContactDetailsList } from '#/views/fdmneimaocrm/contact/components';
import { ContractDetailsList } from '#/views/fdmneimaocrm/contract/components';
import { FollowUp } from '#/views/fdmneimaocrm/followup';
import { PermissionList, TransferForm } from '#/views/fdmneimaocrm/permission';
import { ReceivableDetailsList } from '#/views/fdmneimaocrm/receivable/components';
import { ReceivablePlanDetailsList } from '#/views/fdmneimaocrm/receivable/plan/components';
...
const customer = ref<FdmNeimaoCrmCustomerApi.Customer>(
  {} as FdmNeimaoCrmCustomerApi.Customer,
); // 客户详情
...
function handleBack() {
  ...
  router.push({ name: 'FdmNeimaoCrmCustomer' });
}
      ...
      <TableAction
        :actions="[
          ...
          },
          {
            ...
            auth: ['fdmneimaocrm:customer:update'],
