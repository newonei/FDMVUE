...
import type { FdmNeimaoCrmCustomerLimitConfigApi } from '#/api/fdmneimaocrm/customer/limitConfig';
...
import {
  ...
  LimitConfType,
} from '#/api/fdmneimaocrm/customer/limitConfig';
...
/** 编辑规则 */
function handleEdit(
  row: FdmNeimaoCrmCustomerLimitConfigApi.CustomerLimitConfig,
  type: LimitConfType,
) {
...
const [Grid, gridApi] = useVbenVxeGrid({
  ...
  } as VxeTableGridOptions<FdmNeimaoCrmCustomerLimitConfigApi.CustomerLimitConfig>,
});
</script>
          ...
          :actions="[
            {
              ...
              auth: ['fdmneimaocrm:customer-limit-config:create'],
          ...
          :actions="[
            {
              ...
              auth: ['fdmneimaocrm:customer-limit-config:update'],
            ...
            },
            {
              ...
              auth: ['fdmneimaocrm:customer-limit-config:delete'],
              popConfirm: {
