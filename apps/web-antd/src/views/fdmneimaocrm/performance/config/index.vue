...
import type { FdmNeimaoCrmPerformanceConfigApi } from '#/api/fdmneimaocrm/performance/config';
...
} from '#/api/fdmneimaocrm/performance/config';
...
/** 编辑业绩目标 */
function handleEdit(row: FdmNeimaoCrmPerformanceConfigApi.PerformanceConfig) {
  formModalApi.setData(row).open();
}

/** 删除业绩目标 */
async function handleDelete(
  row: FdmNeimaoCrmPerformanceConfigApi.PerformanceConfig,
) {
...
const [Grid, gridApi] = useVbenVxeGrid({
  ...
  } as VxeTableGridOptions<FdmNeimaoCrmPerformanceConfigApi.PerformanceConfig>,
});
</script>
          ...
          :actions="[
            {
              ...
              auth: ['fdmneimaocrm:performance-config:create'],
          ...
          :actions="[
            {
              ...
              auth: ['fdmneimaocrm:performance-config:update'],
            ...
            },
            {
              ...
              auth: ['fdmneimaocrm:performance-config:delete'],
              popConfirm: {
