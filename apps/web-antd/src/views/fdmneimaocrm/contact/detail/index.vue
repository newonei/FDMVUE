...
import { getContact } from '#/api/fdmneimaocrm/contact';
...
const contact = ref<FdmNeimaoCrmContactApi.Contact>(
  {} as FdmNeimaoCrmContactApi.Contact,
); // 联系人详情
...
function handleBack() {
  ...
  router.push({ name: 'FdmNeimaoCrmContact' });
}
      ...
      <TableAction
        :actions="[
          ...
          },
          {
            ...
            auth: ['fdmneimaocrm:contact:update'],
