...
import { getReceivablePlan } from '#/api/fdmneimaocrm/receivable/plan';
import { useDescription } from '#/components/description';
import { OperateLog } from '#/components/operate-log';
import { $t } from '#/locales';
import { PermissionList } from '#/views/fdmneimaocrm/permission';
import { ReceivablePlanDetailsInfo } from '#/views/fdmneimaocrm/receivable/plan/components';
...
const receivablePlan = ref<FdmNeimaoCrmReceivablePlanApi.Plan>(
  {} as FdmNeimaoCrmReceivablePlanApi.Plan,
);
...
function handleBack() {
  ...
  router.push({ name: 'FdmNeimaoCrmReceivablePlan' });
}
