...
/** 编辑回款 */
function handleEdit(row: FdmNeimaoCrmReceivableApi.Receivable) {
  formModalApi.setData({ receivable: row }).open();
}

/** 删除回款 */
async function handleDelete(row: FdmNeimaoCrmReceivableApi.Receivable) {
...
/** 提交审核 */
async function handleSubmit(row: FdmNeimaoCrmReceivableApi.Receivable) {
  const hideLoading = message.loading({
    content: '提交审核中...',
    duration: 0,
  });
        ...
        <TableAction
          :actions="[
            ...
            },
            {
              ...
              auth: ['fdmneimaocrm:receivable:export'],
        ...
        <TableAction
          :actions="[
            ...
            },
            {
              ...
              auth: ['fdmneimaocrm:receivable:delete'],
              popConfirm: {
