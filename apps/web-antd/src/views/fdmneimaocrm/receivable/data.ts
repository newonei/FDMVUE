...
import { getCustomerSimpleList } from '#/api/fdmneimaocrm/customer';
import {
  getReceivablePlan,
    ...
    },
    {
      ...
      componentProps: {
        options: getDictOptions(
          DICT_TYPE.FDM_NEIMAO_CRM_RECEIVABLE_RETURN_TYPE,
          'number',
        ),
        placeholder: '请选择回款方式',
      },
...
export function useGridColumns(): VxeTableGridOptions['columns'] {
  return [
    ...
    },
    {
      ...
      cellRender: {
        name: 'CellDict',
        props: { type: DICT_TYPE.FDM_NEIMAO_CRM_RECEIVABLE_RETURN_TYPE },
      },
    },
    {
      title: '备注',
    ...
    },
    {
      ...
      cellRender: {
        name: 'CellDict',
        props: { type: DICT_TYPE.FDM_NEIMAO_CRM_AUDIT_STATUS },
      },
    },
    {
      title: '操作',
