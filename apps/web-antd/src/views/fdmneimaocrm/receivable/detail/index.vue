...
import { getReceivable } from '#/api/fdmneimaocrm/receivable';
...
const receivable = ref<FdmNeimaoCrmReceivableApi.Receivable>(
  {} as FdmNeimaoCrmReceivableApi.Receivable,
); // 回款详情
...
function handleBack() {
  ...
  router.push({ name: 'FdmNeimaoCrmReceivable' });
}
      ...
      <TableAction
        :actions="[
          ...
          },
          {
            ...
            auth: ['fdmneimaocrm:receivable:update'],
