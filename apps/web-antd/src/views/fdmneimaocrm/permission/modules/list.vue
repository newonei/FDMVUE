...
import {
  ...
  getPermissionList,
  PermissionLevelEnum,
} from '#/api/fdmneimaocrm/permission';
...
const gridData = ref<FdmNeimaoCrmPermissionApi.Permission[]>([]);
...
const checkedRows = ref<FdmNeimaoCrmPermissionApi.Permission[]>([]);
function setCheckedRows({
  records,
}: {
  records: FdmNeimaoCrmPermissionApi.Permission[];
}) {
...
const [Grid, gridApi] = useVbenVxeGrid({
  ...
  } as VxeTableGridOptions<FdmNeimaoCrmPermissionApi.Permission>,
  gridEvents: {
