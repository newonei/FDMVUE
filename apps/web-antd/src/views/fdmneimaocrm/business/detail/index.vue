...
import type { FdmNeimaoCrmBusinessApi } from '#/api/fdmneimaocrm/business';
...
import { getBusiness } from '#/api/fdmneimaocrm/business';
...
import { ProductDetailsList } from '#/views/fdmneimaocrm/product/components';
...
const business = ref<FdmNeimaoCrmBusinessApi.Business>(
  {} as FdmNeimaoCrmBusinessApi.Business,
); // 商机详情
...
function handleBack() {
  ...
  router.push({ name: 'FdmNeimaoCrmBusiness' });
}
