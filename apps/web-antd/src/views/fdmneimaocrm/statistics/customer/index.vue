...
import type { FdmNeimaoCrmStatisticsCustomerApi } from '#/api/fdmneimaocrm/statistics/customer';
...
import { getChartDatas } from '#/api/fdmneimaocrm/statistics/customer';
...
const [Grid, gridApi] = useVbenVxeGrid({
  ...
  } as VxeTableGridOptions<FdmNeimaoCrmStatisticsCustomerApi.CustomerSummaryByUserRespVO>,
});
