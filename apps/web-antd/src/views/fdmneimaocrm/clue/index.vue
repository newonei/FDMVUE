...
import { deleteClue, exportClue, getCluePage } from '#/api/fdmneimaocrm/clue';
...
/** 编辑线索 */
function handleEdit(row: FdmNeimaoCrmClueApi.Clue) {
  formModalApi.setData(row).open();
}

/** 删除线索 */
async function handleDelete(row: FdmNeimaoCrmClueApi.Clue) {
