...
import { getClue, transformClue } from '#/api/fdmneimaocrm/clue';
...
const clue = ref<FdmNeimaoCrmClueApi.Clue>({} as FdmNeimaoCrmClueApi.Clue); // 线索详情
...
function handleBack() {
  ...
  router.push({ name: 'FdmNeimaoCrmClue' });
}
