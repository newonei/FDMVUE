...
import { getBusiness } from '#/api/fdmwaimaocrm/business';
...
const business = ref<FdmWaimaoCrmBusinessApi.Business>(
  {} as FdmWaimaoCrmBusinessApi.Business,
); // 商机详情
...
function handleBack() {
  ...
  router.push({ name: 'FdmWaimaoCrmBusiness' });
}
