...
/** 编辑商机 */
function handleEdit(row: FdmWaimaoCrmBusinessApi.Business) {
  formModalApi.setData(row).open();
}

/** 删除商机 */
async function handleDelete(row: FdmWaimaoCrmBusinessApi.Business) {
        ...
        <TableAction
          :actions="[
            ...
            },
            {
              ...
              auth: ['fdmwaimaocrm:business:export'],
          ...
          :actions="[
            {
              ...
              auth: ['fdmwaimaocrm:business:update'],
            ...
            },
            {
              ...
              auth: ['fdmwaimaocrm:business:delete'],
              popConfirm: {
