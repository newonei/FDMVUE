...
import { getContract } from '#/api/fdmwaimaocrm/contract';
...
import { ProductDetailsList } from '#/views/fdmwaimaocrm/product/components';
...
const contract = ref<FdmWaimaoCrmContractApi.Contract>(
  {} as FdmWaimaoCrmContractApi.Contract,
); // 合同详情
...
function handleBack() {
  ...
  router.push({ name: 'FdmWaimaoCrmContract' });
}
      ...
      <TableAction
        :actions="[
          ...
          },
          {
            ...
            auth: ['fdmwaimaocrm:contract:update'],
