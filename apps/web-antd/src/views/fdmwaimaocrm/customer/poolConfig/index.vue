...
import type { FdmWaimaoCrmCustomerPoolConfigApi } from '#/api/fdmwaimaocrm/customer/poolConfig';
...
} from '#/api/fdmwaimaocrm/customer/poolConfig';
...
async function handleSubmit() {
  ...
  // 提交表单
  const data =
    (await formApi.getValues()) as FdmWaimaoCrmCustomerPoolConfigApi.CustomerPoolConfig;
  if (!data.enabled) {
