...
import type { FdmWaimaoCrmCustomerApi } from '#/api/fdmwaimaocrm/customer';
...
} from '#/api/fdmwaimaocrm/customer';
import { getOperateLogPage } from '#/api/fdmwaimaocrm/operateLog';
import { BizTypeEnum } from '#/api/fdmwaimaocrm/permission';
import { useDescription } from '#/components/description';
import { OperateLog } from '#/components/operate-log';
import { ACTION_ICON, TableAction } from '#/components/table-action';
import { $t } from '#/locales';
import { BusinessDetailsList } from '#/views/fdmwaimaocrm/business/components';
import { ContactDetailsList } from '#/views/fdmwaimaocrm/contact/components';
import { ContractDetailsList } from '#/views/fdmwaimaocrm/contract/components';
import { FollowUp } from '#/views/fdmwaimaocrm/followup';
import { PermissionList, TransferForm } from '#/views/fdmwaimaocrm/permission';
import { ReceivableDetailsList } from '#/views/fdmwaimaocrm/receivable/components';
import { ReceivablePlanDetailsList } from '#/views/fdmwaimaocrm/receivable/plan/components';
...
const customer = ref<FdmWaimaoCrmCustomerApi.Customer>(
  {} as FdmWaimaoCrmCustomerApi.Customer,
); // 客户详情
...
function handleBack() {
  ...
  router.push({ name: 'FdmWaimaoCrmCustomer' });
}
      ...
      <TableAction
        :actions="[
          ...
          },
          {
            ...
            auth: ['fdmwaimaocrm:customer:update'],
