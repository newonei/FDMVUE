...
import {
  ...
  getPermissionList,
  PermissionLevelEnum,
} from '#/api/fdmwaimaocrm/permission';
...
const gridData = ref<FdmWaimaoCrmPermissionApi.Permission[]>([]);
...
const checkedRows = ref<FdmWaimaoCrmPermissionApi.Permission[]>([]);
function setCheckedRows({
  records,
}: {
  records: FdmWaimaoCrmPermissionApi.Permission[];
}) {
...
const [Grid, gridApi] = useVbenVxeGrid({
  ...
  } as VxeTableGridOptions<FdmWaimaoCrmPermissionApi.Permission>,
  gridEvents: {
