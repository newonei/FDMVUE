...
import { getContact } from '#/api/fdmwaimaocrm/contact';
...
const contact = ref<FdmWaimaoCrmContactApi.Contact>(
  {} as FdmWaimaoCrmContactApi.Contact,
); // 联系人详情
...
function handleBack() {
  ...
  router.push({ name: 'FdmWaimaoCrmContact' });
}
      ...
      <TableAction
        :actions="[
          ...
          },
          {
            ...
            auth: ['fdmwaimaocrm:contact:update'],
