...
import { getProduct } from '#/api/fdmwaimaocrm/product';
...
const product = ref<FdmWaimaoCrmProductApi.Product>(
  {} as FdmWaimaoCrmProductApi.Product,
); // 产品详情
...
function handleBack() {
  ...
  router.push({ name: 'FdmWaimaoCrmProduct' });
}
