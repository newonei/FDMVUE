...
const props = defineProps<{
  bizType: BizTypeEnum;
  products?:
    | FdmWaimaoCrmBusinessApi.BusinessProduct[]
    | FdmWaimaoCrmContractApi.ContractProduct[];
}>();
...
/** 删除产品行 */
function handleDelete(row: FdmWaimaoCrmProductApi.Product) {
...
/** 初始化 */
const productOptions = ref<FdmWaimaoCrmProductApi.Product[]>([]); // 产品下拉选项
onMounted(async () => {
