...
import type { FdmWaimaoCrmStatisticsCustomerApi } from '#/api/fdmwaimaocrm/statistics/customer';
...
import { getChartDatas } from '#/api/fdmwaimaocrm/statistics/customer';
...
const [Grid, gridApi] = useVbenVxeGrid({
  ...
  } as VxeTableGridOptions<FdmWaimaoCrmStatisticsCustomerApi.CustomerSummaryByUserRespVO>,
});
