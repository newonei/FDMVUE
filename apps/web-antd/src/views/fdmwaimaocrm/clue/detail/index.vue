...
import { getClue, transformClue } from '#/api/fdmwaimaocrm/clue';
...
const clue = ref<FdmWaimaoCrmClueApi.Clue>({} as FdmWaimaoCrmClueApi.Clue); // 线索详情
...
function handleBack() {
  ...
  router.push({ name: 'FdmWaimaoCrmClue' });
}
