...
import { getReceivable } from '#/api/fdmwaimaocrm/receivable';
...
const receivable = ref<FdmWaimaoCrmReceivableApi.Receivable>(
  {} as FdmWaimaoCrmReceivableApi.Receivable,
); // 回款详情
...
function handleBack() {
  ...
  router.push({ name: 'FdmWaimaoCrmReceivable' });
}
