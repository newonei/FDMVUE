...
import { getReceivablePlan } from '#/api/fdmwaimaocrm/receivable/plan';
import { useDescription } from '#/components/description';
import { OperateLog } from '#/components/operate-log';
import { $t } from '#/locales';
import { PermissionList } from '#/views/fdmwaimaocrm/permission';
import { ReceivablePlanDetailsInfo } from '#/views/fdmwaimaocrm/receivable/plan/components';
...
const receivablePlan = ref<FdmWaimaoCrmReceivablePlanApi.Plan>(
  {} as FdmWaimaoCrmReceivablePlanApi.Plan,
);
...
function handleBack() {
  ...
  router.push({ name: 'FdmWaimaoCrmReceivablePlan' });
}
      ...
      <TableAction
        :actions="[
          ...
          },
          {
            ...
            onClick: handleEdit,
            auth: ['fdmwaimaocrm:receivable-plan:update'],
          },
        ]"
      />
    </template>
