...
} from '#/api/fdmwaimaocrm/receivable/plan';
...
/** 编辑回款计划 */
function handleEdit(row: FdmWaimaoCrmReceivablePlanApi.Plan) {
  formModalApi.setData(row).open();
}

/** 删除回款计划 */
async function handleDelete(row: FdmWaimaoCrmReceivablePlanApi.Plan) {
...
function handleDetail(row: FdmWaimaoCrmReceivablePlanApi.Plan) {
  push({ name: 'FdmWaimaoCrmReceivablePlanDetail', params: { id: row.id } });
}
          ...
          :actions="[
            {
              ...
              auth: ['fdmwaimaocrm:receivable-plan:create'],
            ...
            },
            {
              ...
              auth: ['fdmwaimaocrm:receivable-plan:export'],
        ...
        <TableAction
          :actions="[
            ...
            },
            {
              ...
              auth: ['fdmwaimaocrm:receivable-plan:delete'],
              popConfirm: {
