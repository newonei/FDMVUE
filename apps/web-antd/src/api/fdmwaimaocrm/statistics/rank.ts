...
export namespace FdmWaimaoCrmStatisticsRankApi {
  /** 排行统计响应 */
...
export function getContractPriceRank(params: PageParam) {
  return requestClient.get<FdmWaimaoCrmStatisticsRankApi.RankRespVO[]>(
    '/fdmwaimaocrm/statistics-rank/get-contract-price-rank',
    { params },
  );
}
...
export function getReceivablePriceRank(params: PageParam) {
  return requestClient.get<FdmWaimaoCrmStatisticsRankApi.RankRespVO[]>(
    '/fdmwaimaocrm/statistics-rank/get-receivable-price-rank',
    { params },
  );
}
...
export function getContractCountRank(params: PageParam) {
  return requestClient.get<FdmWaimaoCrmStatisticsRankApi.RankRespVO[]>(
    '/fdmwaimaocrm/statistics-rank/get-contract-count-rank',
    { params },
  );
}
...
export function getProductSalesRank(params: PageParam) {
  return requestClient.get<FdmWaimaoCrmStatisticsRankApi.RankRespVO[]>(
    '/fdmwaimaocrm/statistics-rank/get-product-sales-rank',
    { params },
  );
}
...
export function getCustomerCountRank(params: PageParam) {
  return requestClient.get<FdmWaimaoCrmStatisticsRankApi.RankRespVO[]>(
    '/fdmwaimaocrm/statistics-rank/get-customer-count-rank',
    { params },
  );
}
...
export function getContactsCountRank(params: PageParam) {
  return requestClient.get<FdmWaimaoCrmStatisticsRankApi.RankRespVO[]>(
    '/fdmwaimaocrm/statistics-rank/get-contacts-count-rank',
    { params },
  );
}
...
export function getFollowCountRank(params: PageParam) {
  return requestClient.get<FdmWaimaoCrmStatisticsRankApi.RankRespVO[]>(
    '/fdmwaimaocrm/statistics-rank/get-follow-count-rank',
    { params },
  );
}
...
export function getFollowCustomerCountRank(params: PageParam) {
  return requestClient.get<FdmWaimaoCrmStatisticsRankApi.RankRespVO[]>(
    '/fdmwaimaocrm/statistics-rank/get-follow-customer-count-rank',
    { params },
  );
}
