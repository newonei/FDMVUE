...
export namespace FdmWaimaoCrmStatisticsFunnelApi {
  /** 销售漏斗统计数据响应 */
...
export function getFunnelSummary(params: any) {
  return requestClient.get<FdmWaimaoCrmStatisticsFunnelApi.FunnelSummaryRespVO>(
    '/fdmwaimaocrm/statistics-funnel/get-funnel-summary',
    { params },
  );
}
...
export function getBusinessSummaryByEndStatus(params: any) {
  return requestClient.get<Record<string, number>>(
    '/fdmwaimaocrm/statistics-funnel/get-business-summary-by-end-status',
    { params },
  );
}
...
export function getBusinessSummaryByStatus(params: any) {
  return requestClient.get<
    FdmWaimaoCrmStatisticsFunnelApi.BusinessSummaryByStatusRespVO[]
  >('/fdmwaimaocrm/statistics-funnel/get-business-summary-by-status', {
    params,
  });
}
...
export function getBusinessSummaryByDate(params: any) {
  return requestClient.get<
    FdmWaimaoCrmStatisticsFunnelApi.BusinessSummaryByDateRespVO[]
  >('/fdmwaimaocrm/statistics-funnel/get-business-summary-by-date', { params });
}

/** 获取商机转化率分析(按日期) */
export function getBusinessInversionRateSummaryByDate(params: any) {
  return requestClient.get<
    FdmWaimaoCrmStatisticsFunnelApi.BusinessInversionRateSummaryByDateRespVO[]
  >(
    '/fdmwaimaocrm/statistics-funnel/get-business-inversion-rate-summary-by-date',
    {
      params,
    },
  );
...
export function getBusinessPageByDate(params: any) {
  return requestClient.get<PageResult<any>>(
    '/fdmwaimaocrm/statistics-funnel/get-business-page-by-date',
    { params },
  );
}
