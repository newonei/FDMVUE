...
export namespace FdmWaimaoCrmStatisticsPortraitApi {
  /** 客户基础统计响应 */
...
export function getCustomerIndustry(params: PageParam) {
  return requestClient.get<
    FdmWaimaoCrmStatisticsPortraitApi.CustomerIndustryRespVO[]
  >('/fdmwaimaocrm/statistics-portrait/get-customer-industry-summary', {
    params,
  });
}
...
export function getCustomerSource(params: PageParam) {
  return requestClient.get<
    FdmWaimaoCrmStatisticsPortraitApi.CustomerSourceRespVO[]
  >('/fdmwaimaocrm/statistics-portrait/get-customer-source-summary', {
    params,
  });
}
...
export function getCustomerLevel(params: PageParam) {
  return requestClient.get<
    FdmWaimaoCrmStatisticsPortraitApi.CustomerLevelRespVO[]
  >('/fdmwaimaocrm/statistics-portrait/get-customer-level-summary', { params });
}

/** 获取客户地区统计数据 */
export function getCustomerArea(params: PageParam) {
  return requestClient.get<
    FdmWaimaoCrmStatisticsPortraitApi.CustomerAreaRespVO[]
  >('/fdmwaimaocrm/statistics-portrait/get-customer-area-summary', { params });
}
