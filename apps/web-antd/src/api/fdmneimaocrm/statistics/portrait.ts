...
export namespace FdmNeimaoCrmStatisticsPortraitApi {
  /** 客户基础统计响应 */
...
export function getCustomerIndustry(params: PageParam) {
  return requestClient.get<
    FdmNeimaoCrmStatisticsPortraitApi.CustomerIndustryRespVO[]
  >('/fdmneimaocrm/statistics-portrait/get-customer-industry-summary', {
    params,
  });
}
...
export function getCustomerSource(params: PageParam) {
  return requestClient.get<
    FdmNeimaoCrmStatisticsPortraitApi.CustomerSourceRespVO[]
  >('/fdmneimaocrm/statistics-portrait/get-customer-source-summary', {
    params,
  });
}
...
export function getCustomerLevel(params: PageParam) {
  return requestClient.get<
    FdmNeimaoCrmStatisticsPortraitApi.CustomerLevelRespVO[]
  >('/fdmneimaocrm/statistics-portrait/get-customer-level-summary', { params });
}

/** 获取客户地区统计数据 */
export function getCustomerArea(params: PageParam) {
  return requestClient.get<
    FdmNeimaoCrmStatisticsPortraitApi.CustomerAreaRespVO[]
  >('/fdmneimaocrm/statistics-portrait/get-customer-area-summary', { params });
}
