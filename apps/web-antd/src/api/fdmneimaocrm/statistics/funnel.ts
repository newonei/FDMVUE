...
export namespace FdmNeimaoCrmStatisticsFunnelApi {
  /** 销售漏斗统计数据响应 */
...
export function getFunnelSummary(params: any) {
  return requestClient.get<FdmNeimaoCrmStatisticsFunnelApi.FunnelSummaryRespVO>(
    '/fdmneimaocrm/statistics-funnel/get-funnel-summary',
    { params },
  );
}
...
export function getBusinessSummaryByEndStatus(params: any) {
  return requestClient.get<Record<string, number>>(
    '/fdmneimaocrm/statistics-funnel/get-business-summary-by-end-status',
    { params },
  );
}
...
export function getBusinessSummaryByStatus(params: any) {
  return requestClient.get<
    FdmNeimaoCrmStatisticsFunnelApi.BusinessSummaryByStatusRespVO[]
  >('/fdmneimaocrm/statistics-funnel/get-business-summary-by-status', {
    params,
  });
}
...
export function getBusinessSummaryByDate(params: any) {
  return requestClient.get<
    FdmNeimaoCrmStatisticsFunnelApi.BusinessSummaryByDateRespVO[]
  >('/fdmneimaocrm/statistics-funnel/get-business-summary-by-date', { params });
}

/** 获取商机转化率分析(按日期) */
export function getBusinessInversionRateSummaryByDate(params: any) {
  return requestClient.get<
    FdmNeimaoCrmStatisticsFunnelApi.BusinessInversionRateSummaryByDateRespVO[]
  >(
    '/fdmneimaocrm/statistics-funnel/get-business-inversion-rate-summary-by-date',
    {
      params,
    },
  );
...
export function getBusinessPageByDate(params: any) {
  return requestClient.get<PageResult<any>>(
    '/fdmneimaocrm/statistics-funnel/get-business-page-by-date',
    { params },
  );
}
